...
export const metadata = {
  title: 'End Guesswork: Dropshipping Profit Predictor', // Already updated this in previous response
  description:
    'Eliminate financial uncertainty in your dropshipping business. Our free AI-powered calculator helps you accurately predict and optimize profit margins for predictable earnings.', // THIS IS THE CORRECTED META DESCRIPTION
}
    ...
    <>
      ...
      <JsonLd<any>
        item={{
          ...
          "description": "Eliminate financial uncertainty in your dropshipping business. Our free AI-powered calculator helps you accurately predict and optimize profit margins, ensuring predictable earnings and confident decision-making.",
