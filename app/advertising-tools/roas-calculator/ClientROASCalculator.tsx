        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            >
              ...
              >
                <strong className="text-pink-500">Ad Spend:</strong> Enter the total amount you&apos;ve spent on your advertising campaign. This is your investment.
              </motion.li>
              <motion.li
                variants={{
                  hidden: { opacity: 0, x: -20 },
              ...
              >
                <strong className="text-pink-500">Revenue:</strong> Input the total revenue generated from the campaign. This is your return.
              </motion.li>
              <motion.li
                variants={{
                  hidden: { opacity: 0, x: -20 },
              ...
              >
                <strong className="text-pink-500">Calculate ROAS:</strong> Click the button to instantly see your Return on Ad Spend, revealing your campaign&apos;s efficiency.
              </motion.li>
              <motion.li
                variants={{
                  hidden: { opacity: 0, x: -20 },
              ...
              >
                <strong className="text-pink-500">Interpreting Your Results:</strong> A ROAS of 1 means you&apos;re breaking even. Anything above 1 indicates profit, while below 1 means you&apos;re losing money. Aim for predictable, positive returns.
              </motion.li>
            </motion.ol>
          </motion.div>
