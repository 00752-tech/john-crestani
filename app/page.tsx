        ...
        <div className="w-full max-w-3xl bg-[#18181b] rounded-2xl shadow-2xl border border-gray-800 flex flex-col md:flex-row items-center gap-8 p-8 md:p-14">
          ...
          <div className="w-full md:w-2/3 text-left">
            ...
            <button
              ...
              className="jason-cta"
            >
              YES! Start My Predictable AI Income Journey &rarr;
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#18142a] py-16 px-4 flex flex-col items-center text-center">
        <div className="max-w-3xl w-full flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-white mb-8 max-w-2xl">
            While others fear the <q className="font-semibold">&apos;skills earthquake&apos;</q> and economic uncertainty, this explosive growth creates unprecedented pathways for <span className="highlight-yellow">financial resilience and career reinvention.</span>{" "}
            <span className="highlight-yellow">Discover how smart marketers are claiming their share.</span>
          </p>
          <Image
