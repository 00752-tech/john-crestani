        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              className="no-hover inline-block bg-gradient-to-r from-pink-500 to-purple-600 text-white py-4 px-12 rounded-full text-xl uppercase font-extrabold tracking-wide select-none cursor-pointer focus:outline-none focus:ring-4 focus:ring-pink-400 transition"
