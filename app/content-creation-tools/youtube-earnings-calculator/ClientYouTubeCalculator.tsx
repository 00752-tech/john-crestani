      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mt-12 bg-gray-900 p-8 rounded-lg">
            <motion.h2 className="text-2xl font-semibold mb-4" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mt-8 bg-gray-900 p-8 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300 mb-6">
              {[
                ...
                <motion.li key={index} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }} dangerouslySetInnerHTML={{ __html: item }} />
              ))}
            </ul>
            <button
