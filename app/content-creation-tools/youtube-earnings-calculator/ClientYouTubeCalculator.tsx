      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <p className="text-xl text-center mb-8 text-gray-300">
            Calculate your potential YouTube earnings based on views, click-through rate (CTR), and cost per thousand impressions (CPM).
          </p>
        ...
        <JsonLd<any>
          item={{
            ...
            "operatingSystem": "Any",
            "description": "Calculate your potential YouTube earnings based on views, CTR, and CPM rates.",
            "creator": {
              "@type": "Person",
              "name": "John Crestani"
            },
