      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <strong>predictable monthly income.</strong> Gain control and make data-driven decisions for stable financial growth in your influencer career.
          </motion.p>
        </div>

        {/* Influencer Earnings Calculator component */}
        <motion.div
        ...
        >
          ...
          <p className="text-sm text-gray-400 mt-4 max-w-xl mx-auto text-center">
