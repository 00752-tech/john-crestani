      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
        ...
        >
          <div className="relative">
            ...
            />
            <motion.div 
              className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full w-38 h-38 md:w-38 md:h-38 flex items-center justify-center text-white font-bold text-base md:text-lg text-center p-4 transform md:translate-x-0 md:-translate-y-1/3"
